        ...
        <div class="col-lg-9 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="book_info_base">
						<span class="book_info_span">
								所有者<a href="#">${bookInfo.author}</a>，
								<a href="#">${bookInfo.press}</a>&nbsp;出品
							</span>
                <span class="book_info_span">
								厂家：<a href="" target="_blank">${bookInfo.press}</a>
							</span>
                <span class="book_info_span">
								生产日期：<fmt:formatDate value="${bookInfo.publishDate}" pattern="yyyy-MM-dd"/>
							</span>
            </div>
                ...
                <div id="book_detail_content" class="nav_content">
                    ...
                    <div id="detail" class="section">
                        ...
                        <div id="bookDetail" class="section">
                            <div class="title">
                                <%--<span class="title_span">商品详情</span>--%>
                            </div>
                            <p>
                                ${bookInfo.detail}
                            </p>
