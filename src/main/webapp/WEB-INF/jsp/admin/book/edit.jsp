...
<div class="container" style="border: 1px solid #CCCCCC;">
    <form class="form-horizontal" role="form" id="bookForm" method="post" action="admin/book/update"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="name" name="name" value="${bookInfo.name}" placeholder="请输入商品名或标题">
            </div>
            <span></span>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="author" value="${bookInfo.author}" name="author" placeholder="请输入商品提供者">
            </div>
            <span></span>
        </div>
        ...
        <div class="form-group">
            <label for="press" class="col-sm-1 control-label" style="padding-left: 0">产家：</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" id="press" name="press" value="${bookInfo.press}" placeholder="请输入公司或者厂家">
            </div>
            <span></span>
        </div>
