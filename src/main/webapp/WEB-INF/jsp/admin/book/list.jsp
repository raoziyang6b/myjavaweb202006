...
<div class="container" style="border: 1px solid #CCCCCC;">
    <div id="searchBook" style="height:100px;border-bottom: 1px solid #CCCCCC;">
        <form action="admin/book/list" class="form-inline" role="form" method="get">
            <div class="form-group">
                <input type="text" class="form-control" id="name" name="keywords" value="${keywords}" placeholder="名称/所有者/isbn">
            </div>

            <button type="submit" class="btn btn-default">
                <span class="glyphicon glyphicon-search"></span> 商品检索
            </button>
        </form>
    </div>
    ...
    <ul class="pagination pagination-lg">
        ...
        <li><a href="javascript:void(0);">共${bookPageInfo.total}个商品</a></li>
    </ul>
</div>
