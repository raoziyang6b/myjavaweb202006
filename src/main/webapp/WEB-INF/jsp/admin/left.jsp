...
<div class="container" id="left-menu" style="padding-right:20px ;background-color: #1b6d85">
        ...
        <div class="panel panel-default left-menu-main-list">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion"
                       href="#collapseTwo">
                        <span class="glyphicon glyphicon-cloud"></span> 商家管理
                    </a>
                </h4>
            </div>
            ...
            <div class="panel panel-default left-menu-main-list">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion"
                           href="#collapseFour">
                            <span class="glyphicon glyphicon-asterisk"></span> 店铺管理
                        </a>
                    </h4>
                </div>
                <div id="collapseFour" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            ...
                            <li>
                                <a href="admin/book/list?page=1" target="centerFrame">商品管理</a>
                            </li>
                            <li>
                                <a href="admin/book/toAddition" target="centerFrame">商品上架</a>
                            </li>
                            <li>
