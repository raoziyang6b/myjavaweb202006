        ...
        <div id="table">
            ...
            <table id="register_table" style="margin-left:310px">
                ...
                <tr>
                    ...
                    <td>
                        <br/>
                        <span style="font-size: 15px;">普通用户</span> <input type="radio" name="identity"
                                                                            value="ordinary"/>

                        <span style="font-size: 15px;">商家用户</span> <input type="radio" name="identity"
                                                                               value="business"/>
                    </td>
                    <td>
                    </td>
                ...
                <tr>
                    ...
                    <span class="a"><a href="page/login" target="_blank">已有账号？立即登录</a>
                </td>
                    </td>
                </tr>
            </table>
